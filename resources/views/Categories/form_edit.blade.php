    ...
    <h2 style="margin: 10px 0px 10px 10px; ">Dashboard</h2>
        <nav>
            <ol class="breadcrumb mb-4 " style="margin-left: 10px;">
                ...
                <li class="breadcrumb-item active">Form Update Categories</li>
            </ol>
        </nav>
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title text-center mb-5">Form UpdateCategories</h5>
                    ...
                    <form class="row g-3" method="POST" action="{{ route('categories.update',$row->id)}}">
                        @csrf
                        @method('PUT')
                        <div class="col-6">
                            <label for="inputNane4" class="form-label">Nama Kategori</label>
                            <input type="text" class="form-control" name="name" value="{{ $row->name }}" placeholder="Nama Kategori">
                        </div>
