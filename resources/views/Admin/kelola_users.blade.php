        ...
        <table id="datatablesSimple">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="7%">
                        @empty($row->foto)
                        <img src="{{ url('assets_admin/img/user/nophoto.png') }}" width="100%" alt="Profile" style="border-radius: 5px;">
                        @else
                        <img src="{{ url('assets_admin/img/user/'.$row->foto) }}" width="100%" alt="Profile" style="border-radius: 5px;">
                        @endempty
                    </td>
                    <td width="15%">
